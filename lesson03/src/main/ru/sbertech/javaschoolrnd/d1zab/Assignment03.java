...
public class Assignment03 {
    ...
    public static void main(String[] args) {
        ...
        if (ParseText.FillLinesAndMap(wordMap, lines, linesSaved, words, srcFile, charset) == false) {
            ...
            // Task 2;
            List<Map.Entry<String, Integer>> list = ParseText.sortWordsLengthInIncreasingOrder(wordMap);
            ...
            // Task 3;
            List<Map.Entry<String, Integer>> list2 = ParseText.sortByValueInDecreasingOrder(wordMap);
